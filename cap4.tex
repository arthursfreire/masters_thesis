...
% Inserir figura da colaboração
{\color{red} Inserir Figura modelo:gad:colaboracao}

\textit{Auto-Organização} é um dos novos nós que foi adicionado ao modelo, mas que está influencia diretamente o TE. Na literatura, é estabelecido que a autoridade da decisão e da liderança de equipes auto-organizáveis precisas ser compartilhada \cite{morgan} \cite{kirkman}. Além disso, ainda em \cite{morgan}, é dito que equipes auto-organizáveis requerem uma capacidade de aprendizagem das equipes para que elas possam adaptar-se às transformações que ocorrem no ambiente. Ainda de acordo com \cite{morgan}, toda equipe que possui a capacidade de se auto-gerenciar precisa de um certo grau de \textit{Redundância}. Logo, com base nessas afirmações, os nós \textit{Liderança Compartilhada}, \textit{Aprendizagem da Equipe} e \textit{Redundância} foram adicionados como pais do nó \textit{Auto-Organização}. Na Figura \ref{modelo:gad:autogerenciamento} está representado o nó \textit{Auto-Organização} em conjunto com seus nós pai.

% Inserir figura do auto-gerenciamento
{\color{red} Inserir Figura modelo:gad:autogerenciamento}
...
% Inserir figura dos atributos da equipe
{\color{red} Inserir Figura modelo:gad:atributos}

Finalmente, após definir os nós do GAD e os relacionamentos entre eles, a Figura \ref{modelo:gad:final} contém o GAD completo.

% Inserir figura dos atributos da equipe
{\color{red} Inserir Figura modelo:gad:final}
